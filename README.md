...
Codmes Search의 전체 흐름과 Ollama/LM Studio VLM 검증 기록은 [docs/notes/codmes-search-explained.md](docs/notes/codmes-search-explained.md)에 쉽게 정리되어 있습니다.
...
- [RAG 백엔드 설계](docs/notes/rag-backend-design.md)
- [Codmes Search 연동](docs/notes/codmes-search-integration.md)
